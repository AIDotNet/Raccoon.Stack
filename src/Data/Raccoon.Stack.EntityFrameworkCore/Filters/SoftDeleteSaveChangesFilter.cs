...
using Raccoon.Stack.Ddd.Domain.Entities.Auditing;
    ...
    where TUserId : IComparable
{
    ...
    private readonly RaccoonDbContextOptions<TDbContext> _raccoonDbContextOptions;
    private readonly ITypeConvertProvider _typeConvertProvider;

    public SoftDeleteSaveChangesFilter(
        RaccoonDbContextOptions<TDbContext> raccoonDbContextOptions,
        TDbContext dbContext,
        IUserContext? userContext = null,
        ITypeConvertProvider? typeConvertProvider = null)
    {
        _userIdType = typeof(TUserId);
        _raccoonDbContextOptions = raccoonDbContextOptions;
        _context = dbContext;
    ...
    {
        if (!_raccoonDbContextOptions.EnableSoftDelete)
            return;
